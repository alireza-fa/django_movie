# Generated by Django 3.2 on 2022-09-20 23:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='children', to='movie.moviecomment', verbose_name='parent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('genre', models.CharField(choices=[('action', 'اکشن'), ('animation', 'انیمیشن'), ('comedy', 'کمدی'), ('crime', 'کرایم'), ('drama', 'درام'), ('experimental', 'اکسپرمنشال'), ('fantasy', 'فانتزی'), ('historical', 'تاریخی'), ('horror', 'وحشت'), ('romance', 'رمانتیک'), ('science', 'علمی'), ('thriller', 'تریلر'), ('western', 'غربی'), ('other', 'دیگر')], max_length=34, verbose_name='genre')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='genres', to='movie.movie', verbose_name='genre')),
            ],
        ),
        migrations.CreateModel(
